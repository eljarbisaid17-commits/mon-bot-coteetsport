...
# Pages à scraper. Chacune révèle un sous-ensemble différent de matchs.
# On combine la grille principale + les principales compétitions pour
# maximiser le nombre de matchs renvoyés.
TARGET_URLS = [
